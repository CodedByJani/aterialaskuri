...
// e2e testien toimivuudeksi otin pois  if (process.env.NODE_ENV !== "test") -ehtolauseen, jotta testit voivat käyttää tietokantaa. Tämä on väliaikainen ratkaisu, ja suosittelen erillisen testitietokannan käyttämistä, jotta tuotantotiedot pysyvät turvassa.
connectDB();
